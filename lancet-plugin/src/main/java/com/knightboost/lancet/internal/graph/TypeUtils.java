...
import static com.knightboost.lancet.internal.util.Constants.CONSTRUCTOR_NAME;

import com.knightboost.lancet.internal.util.CollectionUtils;
import com.knightboost.lancet.internal.util.Constants;
import com.knightboost.lancet.internal.util.Signature;
...
/**
 * Created by Knight-ZXW on 17/3/31.
 */
public class TypeUtils {
    ...
    public static String descToStatic(int access,
                                      String desc,
                                      String className) {
