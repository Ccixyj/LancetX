...
import com.knightboost.lancet.internal.graph.Jsonable;
import com.knightboost.lancet.internal.graph.MethodEntity;
import com.knightboost.lancet.internal.graph.cache.GraphTypeAdapterFactory;
...
public class ClassEntity implements Jsonable {
    ...
    public List< com.knightboost.lancet.internal.graph.FieldEntity> fields;
    ...
    public ClassEntity(int access, String name, String superName, List<String> interfaces, List<FieldEntity> fields, List<MethodEntity> methods, boolean fromAndroid) {
        this.access = access;
        this.name = name;
        this.superName = superName;
        this.interfaces = interfaces;
